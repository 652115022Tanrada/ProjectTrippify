  ...
  >
    ...
    <div class="flex flex-col items-center w-full">
      ...
      <nav class="flex flex-col space-y-6 text-[#0D1282] font-bold font-kanit w-full">
        <button
          @click="goToPage('/')"
          class="flex items-center gap-2 hover:text-[#D71313] transition py-4 px-2"
    ...
    <!-- Modal -->
    <div v-if="showLoginModal" class="fixed inset-0 flex items-center justify-center z-50 bg-white/20 backdrop-blur-[3px]">
