...
<template>
  <div class="flex bg-[#FFFFFF]">
    ...
    <main
      class="flex-1 flex overflow-hidden rounded-l-[32px] bg-[#FFFFFF] ml-48"
    >
        ...
        <div class="w-[50%] p-8 overflow-y-auto">
          <div class="bg-[#EEEDED] rounded-3xl shadow-lg p-8">
            ...
            <div v-show="activeTab === 'plan'">
              <div
                class="mb-6 flex justify-end gap-4"
                v-if="!trip?.tripId || trip?.role === 'leader'"
              >
                <!-- Cancel Trip (เทา) -->
                <div
                  class="relative flex items-center justify-center w-12 h-12 group"
                >
                  <div
              ...
              >
                ...
                <div class="overflow-x-auto">
                  <table class="w-full text-left border-collapse">
                    <thead>
                      <tr
                        class="bg-[#F0DE36] text-[#0D1282] font-bold text-sm tracking-wide"
                      >
